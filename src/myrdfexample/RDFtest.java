...
//        listTypes(inf.getIndividual("http://people/elmerfudd"));
     ...
     */
    private static void addTravelStuff(final Model model) {
    ...
    private static void contoh01(){
        // create the base model
        String SOURCE = "http://www.eswc2006.org/technologies/ontology";
        String SOURCE_FILE = "test/eswc-2006-09-21.rdf";
        String NS = SOURCE + "#";
        OntModel thisbase = ModelFactory.createOntologyModel(OntModelSpec.OWL_MEM);
        thisbase.read(SOURCE_FILE, "RDF/XML");

        // create the reasoning model using the base
        OntModel inf = ModelFactory.createOntologyModel(OntModelSpec.OWL_MEM_MICRO_RULE_INF, thisbase);

        // create a dummy paper for this example
        OntClass paper = thisbase.getOntClass(NS + "Paper");
        Individual p1 = thisbase.createIndividual(NS + "paper1", paper);
        ...
        listTypes(inf.getIndividual(NS + "paper1"));
    }
